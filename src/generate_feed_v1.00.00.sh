...
echo "ctime","country","city","postcode","dnsnames","ipadd","port","abusect","orgname","bgp_prefix","asncode","asnname","dnsnames","self_ca","tls_serial","tls_issuerdn,phishcheck1","phishcheck2","phishcheck3","phishcheck4","phishcheck5","phishcheck6","phishcheck7","phishcheck8","phishcheck9" > Active_Feed_Gmail_"${_DIRUID}".txt

echo "ctime","country","city","postcode","dnsnames","ipadd","port","abusect","orgname","bgp_prefix","asncode","asnname","dnsnames","self_ca","tls_serial","tls_issuerdn,phishcheck1","phishcheck2","phishcheck3","phishcheck4","phishcheck5","phishcheck6","phishcheck7","phishcheck8","phishcheck9" > Inactive_Feed_Gmail_"${_DIRUID}".txt
    ...
    do
        ...
        if [[ $_mailapp == "true" ]]; then
            ...
            then
                ...
                echo "$_ctime","$_country","$_city","$_postcode","$_dnsnames","$_ipadd","$_port","$_abusect","$_orgname", "$_bgp_prefix", "$_asncode", "$_asnname", "$_dnsnames", "$_self_ca", "$_tls_serial", "$_tls_issuerdn,$_phishcheck1", "$_phishcheck2", "$_phishcheck3", "$_phishcheck4", "$_phishcheck5", "$_phishcheck6", "$_phishcheck7", "$_phishcheck8", "$_phishcheck9" >> Active_Feed_Gmail_"$_DIRUID".txt
                ...
                echo "$_ctime","$_country","$_city","$_postcode","$_dnsnames","$_ipadd","$_port","$_abusect","$_orgname", "$_bgp_prefix", "$_asncode", "$_asnname", "$_dnsnames", "$_self_ca", "$_tls_serial", "$_tls_issuerdn,$_phishcheck1", "$_phishcheck2", "$_phishcheck3", "$_phishcheck4", "$_phishcheck5", "$_phishcheck6", "$_phishcheck7", "$_phishcheck8", "$_phishcheck9" >> Inactive_Feed_Gmail_"$_DIRUID".txt
