...
case "$1" in
    ...
    3)
        ...
        ;;
    4)
        _query="labels%3Aopen-dir%20and%20%28services.http.response.body%3A%22.dmg%22%20or%20services.http.response.body%3A%22.exe%22%29%20and%20dns.names%3A%22$_qcase%22"
